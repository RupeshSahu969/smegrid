  ...
  return (
    <footer className="relative bg-gray-900 text-gray-300 py-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 animate-fadeInUp">
...
<img src={logo} alt="SMEGRID Logo" className="h-10 md:h-12 mr-2 bg-white text-white" />
            ...
            <div className="flex space-x-4 mt-6">
              <Link to="#" className="hover:text-orange-400 transition-all hover:scale-110">
                <FaFacebookF />
              </Link>
              <Link>
              <FaLinkedin/>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-1 text-sm">
              ...
              <Link to="#" className="hover:text-orange-400 transition-all">Services</Link>
              <Link to="#" className="hover:text-orange-400 transition-all">About Us</Link>
              <Link to="#" className="hover:text-orange-400 transition-all">Why SMEGRID?</Link>
              <Link to="#" className="hover:text-orange-400 transition-all">Contact Us</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-1 text-sm">
              <Link to="#" className="hover:text-orange-400 transition-all">Metal Procurement</Link>
              <Link to="#" className="hover:text-orange-400 transition-all">Scrap Trading & Management</Link>
              <Link to="#" className="hover:text-orange-400 transition-all">Skilled Labour Supply</Link>
              <Link to="#" className="hover:text-orange-400 transition-all">Custom Solutions</Link>
            </div>
          </div>
  ...
  <div className="flex space-x-6 mt-4 md:mt-0">
    <Link to="#" className="hover:text-orange-400 transition-all">Privacy Policy</Link>
    <Link to="#" className="hover:text-orange-400 transition-all">Terms of Service</Link>
  </div>
</div>
